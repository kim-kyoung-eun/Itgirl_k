...
public class AdminMemberDBqry {
	  ...
	  private  String pageReturn=""  ; //검색시 페이지클릭
		...
		public AdminMemberPageBean Search(AdminMemberPageBean pb) {//검색조건
				//검색
		...
		public AdminMemberPageBean Paging(AdminMemberPageBean pb) {//카운터 받은값을 계산
				total=pb.getTotal();
