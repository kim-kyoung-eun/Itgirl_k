...
<script type="text/javascript">
	...
	function zipcheck() {
		...
		open("zipCheck.jsp", "title",
				"toobar=no, menubar=no, width=500, height=250, left=400, top=300 ");
	}//check end
</script>
...
<body>
	<center>
		<table id="t1" height="30px">
			<tr>
				<td align="left">&nbsp;회원가입</td>
				<td>&nbsp;<input type="radio" checked="checked" name="admin" value="0"/>사용자
		...
		<input type="hidden" name="command" value="insert.do">
			...
			<table id="t1">
				<tr>
					<td height="30" colspan="3" align="right" bgcolor="#FAE0D4"><font
						color=red>*</font> 은 필수입력 사항입니다.</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2">&nbsp;<input type="text" name="id"
						size="30"> <input type="button" onclick="idcheck()"
						value="중복체크"></td>
				</tr>
				<tr>
				...
				<tr>
					<td><font color=red>*</font> 비밀번호확인</td>
					<td colspan="2">&nbsp;<input type="password" name="pwd2"
						size="30"></td>
				</tr>
				<tr>
					<td><font color=red>*</font> 성별</td><td colspan="2" ali>&nbsp;<input type="radio" id="radio1" name="gender"
					value="남" checked><label for="radio1">남자</label> <input
					type="radio" id="radio2" name="gender" value="여"><label
					for="radio2">여자</label></td>
				</tr>
				<tr>
				<td><font color=red>*</font> 생년월일</td><td colspan="2">&nbsp;<script type="text/javascript">
				var today = new Date(); 
				...
				<tr>
					<td><font color=red>*</font>&nbsp;우편번호</td>
					<td colspan="2">&nbsp;<input type=text name="zipcode" size=30>
						<input type="button" onclick="zipcheck()" value="우편번호 검색"></td>
				</tr>
				<tr>
					<td><font color=red>*</font>&nbsp;상세주소</td>
					<td colspan="2">&nbsp;<input type=text name="addr" size=50></td>
				</tr>
				<tr>
					<td><font color=red>*</font>&nbsp;이메일</td>
					<td colspan="2">&nbsp;<input type="text" name="email"
						size="15" maxlength="20" id="email"> @ <select
						name="email">
							<option value=''>선택하세요
				...
				<tr>
					...
					</select> &nbsp;<input type="text" name="phone" size="15" /> <input
						type="text" size="15" name="phone2" /></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp; SMS</td>
					<td colspan="2">&nbsp;<input type="radio" name="SMS1"
						checked="checked" />받음 <input type="radio" name="SMS2" />안받음
					</td>
				</tr>
			</table>
			<table id="t2">
...
이 약관은 It girl 회사(전자상거래 사업자)가 운영하는 It girl 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」
제2조(정의)
①“몰” 이란 It girl 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
5.상품에 대한 교환은 쇼핑몰 내규에의한 1회에 한하며 1회이상 교환일 경우
...
②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.</textarea></td>
				...
				<tr>
					<td colspan="2">이용약관에 동의하십니까?&nbsp;&nbsp;<input type=checkbox>동의함
					</td>
				</tr>
			</table>
			<table id="t2">
				...
				<tr>
					<td><textarea cols="100" rows="10" readonly="readonly">■ 수집하는 개인정보 항목
...
■ 개인정보의 보유 및 이용기간
회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.</textarea></td>
				</tr>
				<tr>
					<td>개인정보 수집 및 이용에 동의하십니까?&nbsp;&nbsp;<input type=checkbox>동의함
					</td>
				</tr>
			</table>

			<input type="button" value="전송" style="height: 25px; width: 55px;">
			<input type="reset" value="취소" style="height: 25px; width: 55px;">
		</form>
